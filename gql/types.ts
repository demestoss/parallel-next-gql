...
import type { DBIssueStatus } from "./types.mapper";
...
export type ResolversTypes = {
	...
	Issue: ResolverTypeWrapper<
		Omit<Issue, "status" | "user"> & {
			status?: Maybe<ResolversTypes["IssueStatus"]>;
	...
	User: ResolverTypeWrapper<
		Omit<User, "issues"> & { issues: Array<Maybe<ResolversTypes["Issue"]>> }
	>;
...
export type ResolversParentTypes = {
	...
	User: Omit<User, "issues"> & {
		issues: Array<Maybe<ResolversParentTypes["Issue"]>>;
	};
...
export type IssueStatusResolvers = EnumResolverSignature<
	{ BACKLOG?: any; DONE?: any; INPROGRESS?: any; TODO?: any },
...
> = {
	...
	editIssue?: Resolver<
		...
		ParentType,
		ContextType,
		RequireFields<MutationEditIssueArgs, "input">
	>;
	signin?: Resolver<
		Maybe<ResolversTypes["AuthUser"]>,
		ParentType,
